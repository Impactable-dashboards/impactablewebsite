    ...
    <div class="foot-bottom">
       <div class="foot-legal">
        ...
        <div class="partner-badges">
          <a class="partner-logo" href="https://business.linkedin.com/advertise/partners/find-a-partner/impactable" target="_blank" rel="noopener" aria-label="LinkedIn Marketing Partner"><img src="/img/marketing-partner-logo.svg" alt="LinkedIn Marketing Partner" width="120" height="43"></a>
          <a class="partner-logo partner-logo--google" href="https://www.google.com/partners/agency?id=1171430902" target="_blank" rel="noopener" aria-label="Google Partner">
            <img src="https://www.gstatic.com/partners/badge/images/2026/PartnerBadgeClickable.svg" alt="Google Partner" height="43">
          </a>
        </div>
      </div>
...
SAAS = {
    ...
    "eyebrow": "Thought Leadership for B2B SaaS &middot; LinkedIn Marketing Partner",
    "h1": "In B2B SaaS, your category sounds identical. <span class=\"text-accent\">Your point of view is the difference.</span>",
...
COACHING = {
    ...
    "eyebrow": "Thought Leadership for Coaches &amp; Trainers &middot; LinkedIn Marketing Partner",
    "h1": "Your expertise is the product. <span class=\"text-accent\">For a coaching or training firm, it only exists when you're in the room.</span>",
...
CONSULTING = {
    ...
    "eyebrow": "Thought Leadership for Consulting Firms &middot; LinkedIn Marketing Partner",
    "h1": "Your consulting firm runs on partner reputations. <span class=\"text-accent\">None of them have time to build one.</span>",
...
IT = {
    ...
    "eyebrow": "Thought Leadership for IT Services &amp; MSPs &middot; LinkedIn Marketing Partner",
    "h1": "Your IT services firm is technically better than the competition. <span class=\"text-accent\">On paper you look identical.</span>",
...
FOUNDER = {
    ...
    "eyebrow": "Founder-Led Thought Leadership &middot; LinkedIn Marketing Partner",
    "h1": "Founder-led means you're the brand. <span class=\"text-accent\">That's your advantage and your bottleneck.</span>",
...
EXPERT = {
    ...
    "eyebrow": "Executive &amp; Expert Thought Leadership &middot; LinkedIn Marketing Partner",
...
FINSERV = {
    ...
    "eyebrow": "Thought Leadership for Financial Services &middot; LinkedIn Marketing Partner",
    "h1": "In financial services, trust is the entire sale. <span class=\"text-accent\">Everyone already claims it.</span>",
...
AGENCY = {
    ...
    "eyebrow": "Thought Leadership for Agencies &middot; LinkedIn Marketing Partner",
    "h1": "Your agency markets everyone else for a living. <span class=\"text-accent\">Your own pipeline runs on referrals.</span>",
...
HR = {
    ...
    "eyebrow": "Thought Leadership for HR &amp; People-Tech &middot; LinkedIn Marketing Partner",
...
STAFFING = {
    ...
    "eyebrow": "Thought Leadership for Staffing &amp; Recruiting &middot; LinkedIn Marketing Partner",
    "h1": "Every staffing and recruiting firm claims the same network <span class=\"text-accent\">and the same top talent.</span>",
...
HEALTHCARE = {
    ...
    "eyebrow": "Thought Leadership for Healthcare &amp; Health Tech &middot; LinkedIn Marketing Partner",
    "h1": "In healthcare, clinical buyers want evidence. <span class=\"text-accent\">Compliance won't let you say anything specific.</span>",
