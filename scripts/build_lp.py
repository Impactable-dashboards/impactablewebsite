...
.cu-embed{background:#16181d;border:0;border-radius:8px;overflow:hidden;height:500px}
.cu-embed iframe{display:block;width:119.05%;height:595px;transform:scale(.84);transform-origin:0 0;border:0}
