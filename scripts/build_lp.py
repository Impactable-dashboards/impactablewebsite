...
.cu-embed{background:transparent;border:1px solid var(--line);border-radius:10px;overflow:hidden;height:528px}
.cu-embed iframe{display:block;width:125%;height:660px;transform:scale(.8);transform-origin:0 0;border:0}
@media(max-width:640px){.cu-embed{height:760px}.cu-embed iframe{width:111.12%;height:840px;transform:scale(.9);transform-origin:0 0}}
/* logo strip */
