...
.hero-grid{display:grid;grid-template-columns:0.9fr 1.1fr;gap:44px;align-items:center}
...
/* form card */
.formcard{background:#16181d;border:1px solid var(--line);border-radius:14px;padding:16px 16px 14px;position:sticky;top:88px}
...
.formcard h2{font-size:1.35rem;color:var(--bone);letter-spacing:-.01em;margin-bottom:10px;line-height:1.2}
...
.cu-embed{background:#16181d;border:0;border-radius:8px;overflow:hidden;height:554px}
.cu-embed iframe{display:block;width:119.05%;height:660px;transform:scale(.84);transform-origin:0 0;border:0}
@media(max-width:640px){.cu-embed{height:800px}.cu-embed iframe{width:108.7%;height:840px;transform:scale(.92);transform-origin:0 0}}
/* logo strip */
...
def form_card():
    ...
    return '''<aside class="formcard" id="demandplan">
        ...
        <div class="cu-embed">
          <iframe id="cuDemandForm" class="clickup-embed" src="https://forms.clickup.com/9010022008/f/8cgm1kr-522071/7B7WZY38TOKDXBRDOF" onwheel="" width="100%" height="600" scrolling="no" style="background:transparent;border:none;" title="Request your free Demand Plan"></iframe>
        </div>
